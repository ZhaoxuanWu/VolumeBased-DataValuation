...
data_fir = 'data/House_sales/kc_house_data.csv' 
...
print("Data nad labels shape:", X.shape, y.shape)
...
pd.DataFrame(extracted_Xs.detach().cpu().numpy()).to_csv('data/House_sales/KingH-NN_features.csv', index=False)
pd.DataFrame(Ys.detach().cpu().numpy()).to_csv('data/House_sales/KingH-labels.csv', index=False)
